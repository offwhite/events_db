...
ActiveRecord::Schema.define(version: 20190401130031) do
  ...
  create_table "event_types", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.date "deleted_at"
    t.bigint "event_department_id"
    t.text "description"
    t.index ["event_department_id"], name: "index_event_types_on_event_department_id"
  end
